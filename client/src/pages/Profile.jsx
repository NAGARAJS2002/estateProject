...
export default function Profile() {
  ...
  return (
    ...
    <form className='flex flex-col gap-4' >
      <input onChange={e=> setFile(e.target.files[0])} className='hidden' type="file"  ref={fileRef} accept='image/*' />
      ...
      <input type="password" id='password' placeholder='username'  className='border p-3 rounded-lg'/>
