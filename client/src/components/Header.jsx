  ...
  return (
   ...
   <h1 className='font-bold text-sm sm:texl-xl flex flex-wrap'>
    ...
    <ul className="flex gap-4">
        ...
        <Link to={'/about'} >
        <li className="hidden sm:inline text-slate-700 hover:underline cursor-pointer ">About
        ...
        <Link to={'/profile'}>
       {currentUser ? (
        <img className="rounded-full h-8 w-8 object-contain " src={currentUser.avatar}alt="profile" />
